import { mysqlTable, mysqlSchema, AnyMySqlColumn, serial, varchar, index, datetime, text, primaryKey } from "drizzle-orm/mysql-core"
...
export const processesSteps = mysqlTable("processes_steps", {
